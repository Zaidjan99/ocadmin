...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $chefDescription = $_POST["Chef_Designation"];

    // File upload handling
    if ($_FILES["Chef_Picture"]["error"] === UPLOAD_ERR_OK) {
        $targetDir = "C:/xampp/htdocs/obpanel/pictures/"; // Update this path to your server's directory
        $targetFile = $targetDir . basename($_FILES["Chef_Picture"]["name"]);
        ...
        if (move_uploaded_file($_FILES["Chef_Picture"]["tmp_name"], $targetFile)) {
            $chefPicture = $targetFile;

            // Prepare and execute the SQL query to insert data using prepared statement
            $stmt = $conn->prepare("INSERT INTO `team` (Chef_Name, Chef_Designation, Chef_Picture) VALUES (?, ?, ?)");

            if (!$stmt) {
                die("Error: " . $conn->error);
            }

            $stmt->bind_param("sss", $chefName, $chefDescription, $chefPicture);
            ...
            if ($stmt->execute()) {
                ...
                $stmt->close();
                $conn->close();
                // Redirect to team.php upon successful submission
                header("Location: team.php");
                exit; // Important: Terminate script to prevent further execution
            } else {
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav" href="#" id="alertsDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <!-- Counter - Alerts -->
                            </a>
                            <!-- Dropdown - Alerts -->
                        ...
                        <!-- Nav Item - Messages -->
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav" href="#" id="messagesDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <!-- Counter - Messages -->
                                </a>
                            <!-- Dropdown - Messages -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add Team</h1>
                    <br><br>
                    <!-- DataTales Example -->
        ...
        <div class="form-row">
          <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="chefName" name="Chef_Name" required>
          </div>
        </div>
        <div class="form-row">
        <div class="form-group col-md-12">
          <label for="chefDescription">Chef Designation</label>
          <input class="form-control" id="chefDescription" name="Chef_Designation" required>
        </div>
        </div>
        <div class="form-group">
          <label for="chefPicture">Chef Picture</label>
          <div class="custom-file">
            <input type="file" class="custom-file-input" id="chefPicture" name="Chef_Picture" required>
      ...
      <br><br><br><br><br><br>
        ...
        <div class="form-group">
          <label for="chefDescription">Chef Position</label>
          <input type="text" class="form-control" id="chefPosition" name="chefPosition" required>        
        </div>
        <div class="form-group">
          <label for="chefPicture">Chef Picture</label>
          <div class="custom-file">
