...
<body id="page-top">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="login_register.php" data-toggle="modal" data-target="#logoutModal">
    ...
    <!-- <li class="list-group-item">
      ...
      <a href="#">Home</a><p>This page features our latest matches, upcoming matches,  news, videos and our blog!</p>
    </li> -->
